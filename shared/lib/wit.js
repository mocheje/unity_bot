 ...
 * 
 * captureTextIntent amended to include State support
 */
...
var captureTextIntent = function (access_token, text, context, callback) {
    if (context) {
        var options = {
            ...
            qs: {'q': text, 'context': JSON.stringify(context)},
            json: true,
 ...
 * @param callback callback that takes 2 arguments err and the response body
 */
var captureSpeechIntent = function (access_token, stream, context, content_type, callback) {
    var options = {
